...
function Soundtrack() {
  return (
    <>
      <Container id="Soundtrack" zindex={1} height="85vh" backgroundColor="#e4e4e4">
        ...
        <FlexContainer backgroundColor="inhierit" justify="space-evenly" align="flex-start">
          ...
          <iframe title="My LoFi Soundtrack" src="https://open.spotify.com/embed/playlist/0vvXsWCC9xrXsKd4FyS8kM" style={{ borderRadius: '20px', boxShadow: '0 28px 48px rgba(0,0,0,.16)' }} width="300" height="380" frameBorder="0" allow="encrypted-media" />
